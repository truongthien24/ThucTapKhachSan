...
export const Register = () => {
    ...
    return (
      <>
        <div className='fixed top-0 left-0 w-screen h-screen bg-[white] z-10 flex flex-col md:flex-row items-center justify-center'>
            <div className='mr-[10px] flex justify-center flex-1'>
              <img src="/images/fly.png" className='w-[200px] md:w-[250px]'/>
            </div>
            <div className="flex-1 justify-center">
              <div 
                className='bg-[white] w-[85%] sm:w-[80%] md:w-[80%] lg:w-[80%] xl:w-[70%] 2xl:w-[70%] rounded-[10px] px-[30px] py-[20px]'
